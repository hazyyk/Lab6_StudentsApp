...
{
    public class StudentsControlController : Controller
    {
        ...
        // GET: StudentsControl/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: StudentsControl/Create
